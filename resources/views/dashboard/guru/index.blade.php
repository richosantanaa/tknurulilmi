                ...
                <div class="card border shadow-lg mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">List Guru</h6>
                                <p class="text-sm"></p>
                            </div>
                            <div class="ms-auto d-flex">
                                <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2"
                                    ...
                                    <span class="btn-inner--text">Add Guru</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body px-0 py-0">
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex align-items-center">
                                                        <img src="/assets/img/guru/{{ $item->gambar }}"
                        ...
                        <div class="border-top py-3 px-3 d-flex align-items-center">
                            ...
                            <div class="ms-auto">
                                ...
                                @else
                                    <a href="{{ $guru->previousPageUrl() }}" class="btn btn-sm btn-white mb-0">Previous</a>
                                @endif

                                @if ($guru->hasMorePages())
                                    <a href="{{ $guru->nextPageUrl() }}" class="btn btn-sm btn-white mb-0">Next</a>
                                @else
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/dashboard/data-guru/{{ $item->id }}" method="POST">
                            @method('DELETE')
                            @csrf
