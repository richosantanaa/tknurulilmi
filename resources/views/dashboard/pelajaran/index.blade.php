...
@section('container')
                ...
                <div class="card border shadow-lg mb-4">
                    <div class="card-header border-bottom pb-0">
                        <div class="d-sm-flex align-items-center">
                            <div>
                                <h6 class="font-weight-semibold text-lg mb-0">List Mata Pelajaran</h6>
                                <p class="text-sm"></p>
                            </div>
                            <div class="ms-auto d-flex">
                                <button type="button" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2"
                                    ...
                                    <span class="btn-inner--text">Add Mata Pelajaran</span>
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-hover align-items-center mb-0">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="text-secondary text-center text-xs font-weight-semibold opacity-7">Nama
                                        </th>
            ...
            <div class="modal-dialog ">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="/dashboard/data-pelajaran/{{ $item->id }}" method="POST">
                            @method('DELETE')
                            @csrf
    ...
    @include('dashboard.pelajaran.add')
    @include('dashboard.pelajaran.edit')
@endsection
